(function (global, factory) {
	...
	_Group.prototype = {
        ...
        remove: function (tween)
        {
            ...
            pw_Array_RemoveIf(this._tweens, pred);
            if(this._tweensAddedDuringUpdate) {
				pw_Array_RemoveIf(this._tweensAddedDuringUpdate, pred);
			}
		},
	...
	TWEEN.Tween.prototype = {
		...
		start: function (time) {
            ...
            if(pw_Utils_IsNullOrUndefined(time)) {
                time = 0;
            }
        ...
        update: function ()
        {
            this._delayToStart -= _pw_Tween_Delta_Time * 1000;
            ...
            this._elapsed += _pw_Tween_Delta_Time * 1000;
